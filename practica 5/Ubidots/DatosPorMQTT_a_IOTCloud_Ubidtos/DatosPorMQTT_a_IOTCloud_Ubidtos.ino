 ...
 * Define Constants 
 ****************************************/ 
#define WIFISSID "CASTOR-PLAY___2.4Gnormal" //WIFI SSID aqui 
#define PASSWORD "Cas123Tor2022" // WIFI pwd 
#define TOKEN "BBFF-QpiHdrAzthzMxjMsYUcEa1UtxxXX" // Ubidots TOKEN name el mismo que usamos en clase 
